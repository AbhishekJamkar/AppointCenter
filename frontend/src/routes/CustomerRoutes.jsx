...
import BusinessDetails from '../Customer/pages/Salon/BusinessDetails/BusinessDetails'
...
import SearchBusiness from '../Customer/pages/Salon/SearchBusiness'
...
<div className='pb-20 min-h-[90vh] mt-[5rem]'>
  <Routes>
    ...
    <Route path='/search' element={<SearchBusiness/>}/>
